...
const RestaurantWebsite = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(
      `Thank you for your message, ${formData.name}! We'll contact you soon.`
    );
    setFormData({
      name: "",
      email: "",
          ...
          <nav className="hidden md:flex space-x-8">
            {["#home", "#about", "#menu", "#contact"].map((item) => (
              <motion.a
                key={item}
                href={item}
                className={`relative text-sm uppercase tracking-wider font-medium text-white ${
                  activeNav === item
                    ? "text-amber-300"
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We believe in the alchemy of exceptional ingredients, masterful
              technique, and passionate storytelling.
            </p>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Founded by Chef Olivier Dubois, Epicure has redefined fine
                dining through our relentless pursuit of perfection. Each dish
                is a harmonious composition of flavors, textures, and visual
                artistry.
              </p>
              <p className="text-gray-600 mb-8">
                We source only the finest seasonal ingredients from trusted
                purveyors, many of whom we've worked with for over a decade. Our
                tasting menus evolve with the seasons, offering guests a journey
                through the year's bounty.
              </p>
      ...
      <section id="menu" className="py-28 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="w-20 h-0.5 bg-amber-400 mx-auto mb-6"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our menu celebrates seasonal ingredients with innovative
            ...
            <div className="inline-flex rounded-md shadow-sm">
              {Object.keys(menuItems).map((tab) => (
                <motion.button
                  ...
                  } first:rounded-l-lg last:rounded-r-lg focus:z-10`}
          ...
          >
            ...
            <p className="text-sm text-gray-500">
              * Please inform us of any dietary restrictions when reserving
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Join us for an unforgettable dining experience. Our team will
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  <span className="font-medium">Reservations:</span> (555)
                  123-4567
                  <br />
                  <span className="font-medium">Email:</span>{" "}
                  reservations@epicure.com
                </p>
      ...
      <footer className="bg-black text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Redefining fine dining through culinary excellence and
          ...
          <div className="text-center text-gray-500 text-sm pt-10 border-t border-gray-800">
            © 2023 EPICURE. All rights reserved. | Designed with{" "}
            <span className="text-red-500">❤️</span> by [Your Name/Agency Name]
          </div>
        </div>
      </footer>
    </div>
